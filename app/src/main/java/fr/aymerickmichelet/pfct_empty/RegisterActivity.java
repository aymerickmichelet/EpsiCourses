...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText registerpage_editText_pseudo,
                     ...
                     registerpage_editText_passwordconfirm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerpage_button_register = findViewById(R.id.registerpage_button_register);
        ...
        registerpage_button_register.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String passwordconfirm =
                        registerpage_editText_passwordconfirm.getText().toString().trim();
                if(pseudo.length() == 0){
